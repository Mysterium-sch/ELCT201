    ...
    void Death::eventHandler(string value) {
        ...
        bool Death::endHandler(string value) {
            ...
            if(people == 0 && cold && dark) {
                output = "\n\rThe world may be vast, but there is no one here. The nomads are gone.\n";
                ending = true;
            }
        }
        cout << output;
